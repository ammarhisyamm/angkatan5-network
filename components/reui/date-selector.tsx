...
import { ArrowBendUpLeftIcon, ArrowBendUpRightIcon, CaretLeftIcon, CaretRightIcon, XIcon } from "@phosphor-icons/react"
      ...
      {years.map((year) => {
        ...
        return (
          <Button
            ...
            size="sm"
            variant={
              isSelected || isRangeStart || isRangeEnd ? "primary" : "outline"
            }
            className={cn(
              inRange &&
                !isSelected &&
