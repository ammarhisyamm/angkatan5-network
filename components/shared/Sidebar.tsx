...
export function Sidebar() {
  ...
  return <aside className={`hidden shrink-0 border-r border-kumo-line bg-kumo-base transition-[width] duration-200 lg:flex ${open ? "w-64" : "w-[72px]"}`}>
    <div className="flex min-h-screen w-full flex-col">
      <header className={`flex min-h-[140px] flex-col gap-5 border-b border-kumo-line px-4 py-5 ${open ? "" : "items-center px-2"}`}>
