...
export function Skeleton({
  ...
  return (
    <div
      className={cn(
        "animate-pulse rounded-xl bg-stroke-soft-200",
        className
      )}
      {...props}
    />
...
export function ProfileCardSkeleton() {
  return (
    <div className="bg-bg-white-0 border border-stroke-soft-200 rounded-xl p-5 flex flex-col gap-4 shadow-regular-xs">
