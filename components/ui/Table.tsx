...
function Header({ className, children, ...props }: React.HTMLAttributes<HTMLTableSectionElement>) { return <thead className={cn("border-b border-kumo-line text-xs font-medium text-kumo-subtle", className)} {...props}>{children}</thead>; }
function Body({ className, children, ...props }: React.HTMLAttributes<HTMLTableSectionElement>) { return <tbody className={cn("divide-y divide-kumo-line", className)} {...props}>{children}</tbody>; }
function Row({ className, children, ...props }: React.HTMLAttributes<HTMLTableRowElement>) { return <tr className={cn("transition-colors hover:bg-kumo-tint", className)} {...props}>{children}</tr>; }
