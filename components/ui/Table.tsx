...
function Header({ className, children, ...props }: React.HTMLAttributes<HTMLTableSectionElement>) { return <thead className={cn("bg-kumo-tint text-xs font-medium text-kumo-subtle", className)} {...props}>{children}</thead>; }
