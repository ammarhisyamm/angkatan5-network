...
function Metric({ label, value, change, detail, icon: Icon }: { label: string; value: string; change?: string; detail: string; icon: typeof Users }) {
  return <div className="min-w-0 px-4 first:pl-0 sm:px-6 lg:border-l lg:border-stroke-soft-200">
...
export default function AdminDashboardPage() {
  ...
  return <div className="pb-8">
    <header className="flex flex-col gap-5 border-b border-stroke-soft-200 pb-6 sm:flex-row sm:items-center sm:justify-between">
    ...
    <section className="grid grid-cols-2 gap-y-8 border-b border-stroke-soft-200 py-7 sm:grid-cols-3 lg:grid-cols-6">
    ...
    <div className="grid grid-cols-1 gap-8 pt-8 xl:grid-cols-[minmax(0,1fr)_340px]">
      <div className="space-y-8">
        <section className="border-b border-stroke-soft-200 pb-8">
